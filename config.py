...
MACRO_LIST = [
    ...
    # A股指数（无标签）
    # ============================================================
    {"symbol": "000001.SH", "name": "上证指数", "type": "index", "feature": "**中国A股市场历史最悠久、最具代表性的指数**，1991年7月15日正式发布，基日1990年12月19日，基点100点。由在上交所上市的符合条件的股票与存托凭证组成样本，2020年7月修订编制方案后纳入科创板证券，总市值超52万亿元，成分股数量2249只，被国内外投资者广泛使用"},
    {"symbol": "399006.SZ", "name": "创业板指100", "type": "index", "feature": "**创业板市场核心指数**，2010年6月1日正式发布，基日2010年5月31日，基点1000点。由最具代表性的100家创业板上市企业股票组成，新兴产业、高新技术企业占比高，成长性突出，与深证成指、中小板指数共同构成反映深交所上市股票运行情况的核心指数体系"},
    {"symbol": "000300.SH", "name": "沪深300 大盘蓝筹", "type": "index", "feature": "**A股大盘蓝筹代表**，由沪深市场中规模大、流动性好的300只股票组成，反映A股核心资产整体表现，是国内外投资者最常用的A股配置基准指数"},
    {"symbol": "000905.SH", "name": "中证500 中盘", "type": "index", "feature": "**A股中盘成长代表**，由沪深两市中剔除沪深300后市值排名前500的股票组成，反映中等市值公司的整体表现，是捕捉A股成长机会的重要工具"},
