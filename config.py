...
THEME_MAPPING = {
    ...
    # 9. 云・模型・应用
    # ============================================================
    "9. 云・模型・应用": ["云服务IaaS", "基础模型", "AI应用", "智能体Agent", "AI内容生成", "IP运营"],
...
WATCHLIST = [
    ...
    {"symbol": "2962.T", "name": "テクニスコ(Tecnisco)", "market": "日股", "sector": "1.2", "industry": "1.2.1", "feature": "**精密加工部件龙头**，主营**散热片（半导体激光器/功率半导体/MPU用）**、**玻璃贯穿配线基板**、**硅部件**等。核心客户覆盖富士电机、三菱电机、古河电气工业、安立、爱德万测试、滨松光子、NTT Electronics等龙头半导体及光通信设备制造商", "tags": ["散热片", "功率半导体", "玻璃贯穿配线基板", "硅部件", "硅基板"]},
