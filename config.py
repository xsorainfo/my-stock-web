...
MACRO_LIST = [
    ...
    # ETF（紫色）
    # ============================================================
    {"symbol": "SMH", "name": "半导体 ETF", "type": "etf"},
    {"symbol": "AIQ", "name": "AI 指数 ETF", "type": "etf"},
    {"symbol": "BOTZ", "name": "机器人/AI ETF", "type": "etf"},
    #一、AI全生态与主题类（覆盖更广）**

    {"symbol": "CHAT", "name": "生成式AI与科技ETF", "type": "etf", "feature": "**精准押注生成式AI赛道**，采用主动量化模型分析公司财报电话会议文本，评估与生成式AI的关联度进行选股。聚焦语言模型、内容生成等核心领域，成立以来表现突出"},
    {"symbol": "AIS", "name": "AI超级周期ETF", "type": "etf", "feature": "**深耕AI基础设施"卖水人"**，由AI专家委员会拆解构建AI数据中心和芯片的真实成本，沿供应链寻找实质性受益公司。与标普500重叠度低，高度偏向半导体和关键硬件供应商，提供纯正AI基础设施敞口"},
    {"symbol": "WTAI", "name": "AI与创新基金", "type": "etf", "feature": "**覆盖人工智能价值链的主动型ETF**，涵盖芯片、软件、应用等全产业链环节，持仓灵活调整，捕捉AI从技术突破到商业落地的全周期机会"},
    {"symbol": "AGIX", "name": "人工智能与科技ETF", "type": "etf", "feature": "**打通公私界限，捕捉未上市独角兽**，持仓包含Anthropic等非上市明星AI企业，为普通投资者提供通常仅限风投触及的机会。通过内部公允价值委员会对私人持股动态估值"},
    #二、机器人/物理AI（实体化AI）**
    
    {"symbol": "ROBO", "name": "机器人与自动化指数ETF", "type": "etf", "feature": "**持仓更分散的机器人ETF**（权重多落在1-2%之间），避免过度集中风险。覆盖全球机器人与自动化供应链，自2024年初以来表现微幅领先BOTZ"},
    {"symbol": "BOTT", "name": "人形机器人ETF", "type": "etf", "feature": "**专注人形机器人赛道**，捕捉人形机器人从概念到量产的投资机会。在AI赋能物理世界的趋势下，人形机器人被视为继工业机器人后的下一个爆发点"},
    #三、AI能源与基础设施（算力的电力底座）**    
    {"symbol": "TCAI", "name": "AI基础设施ETF", "type": "etf", "feature": "**聚焦AI的"能源底座"**，投资范围超越传统数据中心，延伸至发电企业、电网运营商、建筑技术公司等。AI耗电量激增（预计需3倍扩容）使电力基础设施成为刚需"},
    #四、半导体细分（更精准的算力敞口）**
    {"symbol": "SOXX", "name": "iShares半导体ETF", "type": "etf", "feature": "**与SMH同为半导体核心ETF**，持仓略有差异，可作分散配置。覆盖全球半导体产业链龙头，是AI基础设施层的基础配置工具"},
    {"symbol": "DRAM", "name": "存储芯片ETF", "type": "etf", "feature": "**专注存储芯片赛道**，今年涨幅高达86%，捕捉HBM/DDR5等AI存储需求爆发的结构性机会。AI训练对高带宽内存的需求使存储芯片成为除GPU外的第二大受益环节"},
    {"symbol": "CHPS", "name": "AI半导体指数ETF", "type": "etf", "feature": "**聚焦AI专用半导体**，区别于传统半导体ETF，持仓更偏向GPU、ASIC、HBM等AI核心芯片，纯度更高"},
    
    #五、科技宽基（关注AI变现阶段）**
    
    {"symbol": "QQQ", "name": "纳指100ETF", "type": "etf", "feature": "**纳斯达克100宽基**，覆盖苹果、微软、英伟达、谷歌等AI巨头，是把握AI大方向的基础工具。自2024年初以来表现持续领先纯机器人主题ETF，适合做核心配置"},
    #六、日本/亚洲AI主题（捕捉东亚供应链）**    
    {"symbol": "2243.T", "name": "Global X半导体ETF(日股)", "type": "etf", "feature": "**东证上市的SOX指数ETF**，用日元即可投资美国半导体龙头（31家成分股），包括英伟达、台积电、AMD等。上市约2.5年价格约2.1倍，是日元投资者参与AI算力赛道的便利工具"},
    #补充逻辑说明：** 搜索结果显示，AI投资已从"军备竞赛"转向"变现阶段"，但底层需求仍为长期刚性，建议核心仓位（40-50%）配置半导体ETF，卫星仓位配置机器人、AI应用、电力等主题。
    # ============================================================
    # 国债/债券（粉色）
    # ============================================================
